...
const SearchResult = ({ course}) => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-300 py-4 gap-4">
      ...
      ><img src={course.courseThumbnail} alt=""  className="h-32 w-full md:w-56 object-cover rounded"/>
...
<p className="text-sm text-gray-700">Instuctor: <span className="font-bold">{course.creator?.name}</span></p>
